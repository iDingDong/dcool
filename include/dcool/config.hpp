...
#		define DCOOL_CPP_ATOMIC_WAIT_VERSION_FOR_P1135R6 201907L
...
#		define DCOOL_CPP_ATOMIC_FLAG_TEST_VERSION_FOR_P1135R6 201907L
...
#	else
#		if \
			DCOOL_CPP_ATOMIC_WAIT_VERSION >= DCOOL_CPP_ATOMIC_WAIT_VERSION_FOR_P1135R6 && \
			DCOOL_CPP_SEMAPHORE_VERSION >= 201907L && \
			DCOOL_CPP_LATCH_VERSION >= 201907L && \
			DCOOL_CPP_BARRIER_VERSION >= 201907L && \
			DCOOL_CPP_ATOMIC_FLAG_TEST_VERSION >= DCOOL_CPP_ATOMIC_FLAG_TEST_VERSION_FOR_P1135R6 && \
...
#	define DCOOL_CPP_STANDARD_LIBRARY_LIBSTDCPP 1
#	define DCOOL_CPP_STANDARD_LIBRARY_LIBCPP 2

#	if defined(_LIBCPP_VERSION)
#		define DCOOL_CPP_STANDARD_LIBRARY DCOOL_CPP_STANDARD_LIBRARY_LIBCPP
#	elif defined(__GLIBCXX__)
#		define DCOOL_CPP_STANDARD_LIBRARY DCOOL_CPP_STANDARD_LIBRARY_LIBSTDCPP
#	else
#		define DCOOL_CPP_STANDARD_LIBRARY DCOOL_UNKNOWN
#	endif

#	if DCOOL_COMPILER == DCOOL_COMPILER_GCC
#		define DCOOL_DEPENDENCY_BUG_1 1
#	else
#		define DCOOL_DEPENDENCY_BUG_1 0
#	endif

#	if DCOOL_CPP_STANDARD_LIBRARY == DCOOL_CPP_STANDARD_LIBRARY_LIBSTDCPP
#		define DCOOL_DEPENDENCY_BUG_4 1
#	else
#		define DCOOL_DEPENDENCY_BUG_4 0
#	endif
