...
namespace dcool::coroutine {
	...
	namespace detail_ {
		template <typename ResultT_, typename ConfigT_> class TaskPromise_ {
			...
			public: static constexpr ::dcool::core::Boolean hasReturnValue_ = ::dcool::core::NonVoid<Result>;

			public: using Underlying_ = ::dcool::core::ConditionalType<hasReturnValue_, Value_*, ::dcool::core::Pit>;
			...
			private: [[no_unique_address]] Underlying_ m_result_ = ::dcool::core::nullPointer;
			...
			public: template <typename ValueT__> constexpr auto return_value(
				ValueT__&& value_
			) noexcept -> ::dcool::coroutine::SuspendAlways requires (
				hasReturnValue_ && ::dcool::core::ConvertibleTo<ValueT__&&, Result>
			) {
